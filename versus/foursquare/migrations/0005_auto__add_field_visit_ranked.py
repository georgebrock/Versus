...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.ranked'
        db.add_column('foursquare_visit', 'ranked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Visit.ranked'
        db.delete_column('foursquare_visit', 'ranked')
