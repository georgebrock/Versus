...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.last_checkin_update'
        db.alter_column('foursquare_userprofile', 'last_checkin_update', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'UserProfile.last_checkin_update'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.last_checkin_update' and its values cannot be restored.")
    ...
    models = {
        ...
        'foursquare.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checkin_update': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
