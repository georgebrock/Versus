...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visit.score'
        db.add_column('foursquare_visit', 'score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Visit.score'
        db.delete_column('foursquare_visit', 'score')
